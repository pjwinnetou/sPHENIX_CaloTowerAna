...
int ClusterIso::process_event(PHCompositeNode *topNode)
{
  ...
  {
    {
      ...
      //get EMCal towers
      TowerInfoContainer *towersEM3old = findNode::getClass<TowerInfoContainerv2>(topNode, "TOWERINFO_CALIB_CEMC_RETOWER_SUB1");
      ...
      TowerInfoContainer *towersIH3 = findNode::getClass<TowerInfoContainerv2>(topNode, "TOWERINFO_CALIB_HCALIN_SUB1");
      ...
      TowerInfoContainer *towersOH3 = findNode::getClass<TowerInfoContainerv2>(topNode, "TOWERINFO_CALIB_HCALOUT_SUB1");
  ...
  if (m_do_unsubtracted)
  {
    ...
    {
      //get EMCal towers
      TowerInfoContainer *towersEM3old = findNode::getClass<TowerInfoContainerv2>(topNode, "TOWERINFO_CALIB_CEMC");
      if (Verbosity() >= VERBOSITY_MORE) std::cout << "ClusterIso::process_event: " << towersEM3old->size() << " TOWERINFO_CALIB_CEMC towers" << '\n';

      //get InnerHCal towers
      TowerInfoContainer *towersIH3 = findNode::getClass<TowerInfoContainerv2>(topNode, "TOWERINFO_CALIB_HCALIN");
      if (Verbosity() >= VERBOSITY_MORE) std::cout << "ClusterIso::process_event: " << towersIH3->size() << " TOWERINFO_CALIB_HCALIN towers" << '\n';

      //get outerHCal towers
      TowerInfoContainer *towersOH3 = findNode::getClass<TowerInfoContainerv2>(topNode, "TOWERINFO_CALIB_HCALOUT");
